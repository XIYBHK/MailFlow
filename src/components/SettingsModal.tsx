    ...
    >
      ...
      >
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
          <h2 style={{ fontSize: '20px', fontWeight: 'bold', margin: 0, color: '#f3f4f6' }}>邮箱账户设置</h2>
          <button
            onClick={onClose}
            style={{
              background: 'none',
        ...
        {accounts.length > 0 && (
          <div style={{ marginBottom: '24px' }}>
            <h3 style={{ fontSize: '16px', fontWeight: '600', marginBottom: '12px', color: '#e5e7eb' }}>已添加的账户</h3>
            <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
              {accounts.map(account => (
                ...
                >
                  <div>
                    <div style={{ fontWeight: '500', fontSize: '14px', color: '#f3f4f6' }}>{account.name}</div>
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          <h3 style={{ fontSize: '16px', fontWeight: '600', marginBottom: '4px', color: '#e5e7eb' }}>添加新账户</h3>

          <div>
            <label style={{ display: 'block', marginBottom: '4px', fontWeight: '500', fontSize: '14px', color: '#d1d5db' }}>
              邮箱服务商
            </label>
            <select
              value={provider}
